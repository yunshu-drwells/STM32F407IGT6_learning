...
void HAL_HCD_Connect_Callback(HCD_HandleTypeDef *hhcd)
{
  printf("Connected \r\n");
	//hhcd = &g_hhcd_USB_OTG_FS;
	//printf("HAL_HCD_Connect_Callback->hhcd: %p\n", hhcd);
	//printf("HAL_HCD_Connect_Callback->phost: %p\n", hhcd->pData);
	
  //printf("Before USBH_LL_Connect: phost->device.is_disconnected before: %u\n", ((USBH_HandleTypeDef *)hhcd->pData)->device.is_disconnected);
  //printf("Before USBH_LL_Connect: phost->device.is_ReEnumerated before: %u\n", ((USBH_HandleTypeDef *)hhcd->pData)->device.is_ReEnumerated);
	
	//printf("Before USBH_LL_Connect: phost->device.is_connected:%u\n", ((USBH_HandleTypeDef *)hhcd->pData)->device.is_connected);
  USBH_LL_Connect(hhcd->pData);
	
	//printf("After USBH_LL_Connect: phost->device.is_disconnected before: %u\n", ((USBH_HandleTypeDef *)hhcd->pData)->device.is_disconnected);
  //printf("After USBH_LL_Connect: phost->device.is_ReEnumerated before: %u\n", ((USBH_HandleTypeDef *)hhcd->pData)->device.is_ReEnumerated);
	//printf("After USBH_LL_Connect: phost->device.is_connected:%u\n", ((USBH_HandleTypeDef *)hhcd->pData)->device.is_connected);
}
...
{
		//printf("USBH_LL_GetURBState is called\n");
