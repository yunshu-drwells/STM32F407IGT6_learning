...
#define USART_TX_GPIO_PIN                   SYS_GPIO_PIN6
#define USART_TX_GPIO_AF                    7                           /* AF功能选择 */
#define USART_TX_GPIO_CLK_ENABLE()          do{ RCC->AHB1ENR |= 1 << 1; }while(0)   /* PB口时钟使能 */

#define USART_RX_GPIO_PORT                  GPIOB
#define USART_RX_GPIO_PIN                   SYS_GPIO_PIN7
#define USART_RX_GPIO_AF                    7                           /* AF功能选择 */
#define USART_RX_GPIO_CLK_ENABLE()          do{ RCC->AHB1ENR |= 1 << 1; }while(0)   /* PB口时钟使能 */
